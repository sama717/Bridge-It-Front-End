...
const Footer = () => {
  ...
  return (
    <React.Fragment>
      <div
        className="container-fluid bg-white text-dark footer pt-5 mt-5 wow fadeIn"
        data-wow-delay="0.1s"
      ...
      >
        <div className="container py-4">
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <p className="section-title ff-secondary text-start fw-bold mb-4">
                Our Company
              </p>
              {companyLinks.map((link, index) => (
                <a
                  key={index}
                  className="btn d-flex align-items-center text-dark mb-2"
                  href={link.Link}
            ...
            <div className="col-lg-3 col-md-6">
              ...
              <div
                ...
                style={{ maxWidth: 400, height: "50px" }}
              >
                <input
                ...
                />
                {error && (
                  <div style={{ color: "red", marginTop: "1px" }}>{error}</div>
                )}
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="copyrights">
            <div className="row">
              <div
                className="col-md-6 text-md-start mb-md-0"
                style={{
                  color: "#8F90A6",
                  fontSize: "12px",
                  fontWeight: "550",
