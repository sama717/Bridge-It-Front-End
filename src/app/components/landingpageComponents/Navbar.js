...
export default function Header() {
    ...
    useEffect(() => {
        // It's better to import Bootstrap in _app.js or _document.js
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className='navbar-nav me-auto mb-4 mb-lg-0 ms-2'>
                        <li className={`nav-item ${isActive('/')}`}>
                            <Link className='nav-link me-3' href="/">Home</Link>
                        </li>
                        <li className={`nav-item ${isActive('/features')}`}>
                            <Link className='nav-link me-3' href="/features">Features</Link>
                        </li>
                        <li className={`nav-item ${isActive('/plans')}`}>
                            <Link className='nav-link me-3' href="/plans">Plans & Pricing</Link>
                        </li>
                        <li className={`nav-item ${isActive('/about')}`}>
                            <Link className='nav-link me-3' href="/about">About Us</Link>
                        </li>
                        <li className={`nav-item ${isActive('/companies-schools')}`}>
                            <Link className='nav-link comp-school me-3' href="/companies-schools">Companies/Schools</Link>
                        </li>
                    </ul>
                    <div className='access-buttons'>
                        ...
                        <Link href="/login">
                            <button className='btn btn-light text-primary login-btn fw-bold'>Log In</button>
                        </Link>
                        <Link href='/signup'>
