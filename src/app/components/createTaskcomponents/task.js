    ...
    <Container className='mt-4'>
      <Row>
        <Col className={`${styles.taskhead} me-1`} sm>
          Today’s Tasks <button className={`ms-1 ${styles.taskCounter}`}>3</button>
          <div className={styles.addtask}>
            <button className={styles.plussign}>+</button>
          </div>
        </Col>
        <Col className={`${styles.taskhead} me-1`} sm>
          Upcoming tasks <button className={`ms-1 ${styles.taskCounter}`}>3</button>
          <div className={styles.addtask}>
            <button className={styles.plussign}>+</button>
          </div>
        </Col>
        <Col className={`${styles.taskhead} me-1`} sm>
          Completed tasks <button className={`ms-1 ${styles.taskCounter}`}>3</button>
          <div className={styles.addtask}>
            <button className={styles.plussign}>+</button>
          </div>
        </Col>
      ...
      <Row className='mt-3'>
        <Col sm>
          <Card style={{ width: '17rem' }}>
            <Card.Body>
              <Link href={`/dashboard/workspace/${groupId}/Task`}>
